...
test_that("Background Class Loads Properly",
{
...
context("Background Class Fails Properly")
test_that("Background Class Fails Properly",
{
  source('C:/Users/a421356/R-GitHub/SCsim/R/background.R')
...
context("Background Class Member Functions Return Properly")
test_that("Background Class Member Functions Return Properly",
{
  source('C:/Users/a421356/R-GitHub/SCsim/R/background.R')
